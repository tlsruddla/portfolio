...
int main(int argc, char *argv[]) {
    ...
    CLIENT_INFO client_info[MAX_CLNT] = {
        ...
        {0, -1, "", "15", "PASSWD"},       {0, -1, "", "USER1", "PASSWD"},
        {0, -1, "", "USER2", "PASSWD"},    {0, -1, "", "USER", "PASSWD"},
        {0, -1, "", "JETSON", "PASSWD"},   {0, -1, "", "APP", "PASSWD"},
        {0, -1, "", "ROS", "PASSWD"},      {0, -1, "", "WORKER", "PASSWD"},
        {0, -1, "", "CUSTOMER", "PASSWD"}, {0, -1, "", "BOX", "PASSWD"},
        {0, -1, "", "CENTER", "PASSWD"},   {0, -1, "", "SGR_SQL", "PASSWD"},
        {0, -1, "", "SGR_BT", "PASSWD"},   {0, -1, "", "SGR_STM32", "PASSWD"},
        {0, -1, "", "SGR_LIN", "PASSWD"},  {0, -1, "", "SGR_AND", "PASSWD"},
        {0, -1, "", "SGR_ARD", "PASSWD"},  {0, -1, "", "HM_CON", "PASSWD"}};
